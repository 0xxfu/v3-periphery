...
library NFTDescriptor {
    ...
    function adjustForDecimalPrecision(
        ...
        uint256 difference = abs(int8(baseTokenDecimals)- int8(quoteTokenDecimals));
    ...
    function generateSVGImage(ConstructTokenURIParams memory params) internal pure returns (string memory svg) {
        NFTSVG.SVGParams memory svgParams =
            NFTSVG.SVGParams({
                ...
                color0: tokenToColorHex(uint160(params.quoteTokenAddress), 136),
                color1: tokenToColorHex(uint160(params.baseTokenAddress), 136),
                color2: tokenToColorHex(uint160(params.quoteTokenAddress), 0),
                color3: tokenToColorHex(uint160(params.baseTokenAddress), 0),
                x1: scale(getCircleCoord(uint160(params.quoteTokenAddress), 16, params.tokenId), 0, 255, 16, 274),
                y1: scale(getCircleCoord(uint160(params.baseTokenAddress), 16, params.tokenId), 0, 255, 100, 484),
                x2: scale(getCircleCoord(uint160(params.quoteTokenAddress), 32, params.tokenId), 0, 255, 16, 274),
                y2: scale(getCircleCoord(uint160(params.baseTokenAddress), 32, params.tokenId), 0, 255, 100, 484),
                x3: scale(getCircleCoord(uint160(params.quoteTokenAddress), 48, params.tokenId), 0, 255, 16, 274),
                y3: scale(getCircleCoord(uint160(params.baseTokenAddress), 48, params.tokenId), 0, 255, 100, 484)
            });
